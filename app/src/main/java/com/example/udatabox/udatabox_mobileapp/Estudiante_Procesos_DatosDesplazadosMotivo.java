...
public class Estudiante_Procesos_DatosDesplazadosMotivo extends ActionBarActivity {
    String iduser, radicado_id,codigo_usuario;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_estudiante__procesos__datos_desplazados_motivo);
        Intent i = getIntent();
    ...
    public class Conexion extends AsyncTask<String, Void, String> {
        ...
        protected String doInBackground(String... arg0) {
            ...
            try {
                ...
                nameValuePairs.add(new BasicNameValuePair("actividad", "desplazado_motivo"));
        ...
        protected void onPostExecute(String result) {
            try {
                ...
                for (int i = 0; i < jArray.length(); i++) {
                    ...
                    TextView textView;
                    if (json_data.has("motivo")) {
                        textView = (TextView) findViewById(R.id.tw_P_DezplazamintoMotivo);
                        textView.setText(json_data.getString("motivo"));
                    }
                }
