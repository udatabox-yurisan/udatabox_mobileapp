...
public class Estudiante_Procesos_DatosAsesorias extends ActionBarActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_estudiante__procesos__datos_asesorias);
        Intent i = getIntent();
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.menu_estudiante__procesos__datos_asesorias, menu);
        return true;
    }
    ...
    public class Conexion extends AsyncTask<String, Void, String> {
        ...
        protected String doInBackground(String... arg0) {
            ...
            try {
                ...
                nameValuePairs.add(new BasicNameValuePair("actividad", "datos_asesoria"));
        ...
        protected void onPostExecute(String result) {
            try {
                ...
                for (int i = 0; i < jArray.length(); i++) {
                    ...
                    TextView textView;
                    if (json_data.has("asesoria")) {
                        textView = (TextView) findViewById(R.id.tw_P_AsesoriaJuridica);
                        textView.setText(json_data.getString("asesoria"));
                    }
                }
